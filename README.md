...
### Public  *(no auth — QR scan flow, rate-limited 10 req / 15 min)*
...
Built in 6 ordered phases — all complete and tested:

1. **Project setup** — server bootstrap, config, DB, base middleware
2. **Models** — Mongoose schemas for the core domain
3. **Auth** — register/login, JWT, auth middleware
4. **Asset / QR** — asset CRUD and QR generation/resolution
5. **Issue / AI triage** — issue reporting + AI-assisted triage
6. **Maintenance / history** — maintenance actions + per-asset audit trail
